...
export const projects = [
  ...
  },
  {
    ...
    links: [
      {
        label: 'Candidate App',
        url: 'https://play.google.com/store/apps/details?id=com.jobulus.candidate&hl=en',
      },
      {
        label: 'Recruiter App',
        url: 'https://play.google.com/store/apps/details?id=com.jobulus.recruiter&hl=en',
      },
      {
        label: 'Website',
